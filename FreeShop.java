...
public class FreeShop {
    ...
    public FreeShop(int capacidad, int cajas,int nombre) {
    ...
    public void entrarFreeShop(int nombre) throws InterruptedException {
        System.out.println( Color.ROSA_FUERTE + "Pasajero " + nombre + " intenta entrar al free shop numero "+this.nombre + Color.RESET);
        if (this.capacidad.tryAcquire(2, TimeUnit.SECONDS)) {
            try {
                ...
                if(quiereComprar==1){
                    if(this.cajas.tryAcquire(1, TimeUnit.SECONDS)){
                        ...
                        System.out.println(Color.ROSA_FUERTE + "Pasajero " + nombre + " ve que no hay cajas disponibles en el free shop numero "+this.nombre+", se cansa de esperar y vuelve a la sala de espera de embarque" + Color.RESET);
                    }
                } else {
                    System.out.println(Color.ROSA_FUERTE + "Pasajero " + nombre + " decide no comprar nada en el free shop numero "+this.nombre+ Color.RESET);
            ...
            System.out.println(Color.ROSA_FUERTE + "Pasajero " + nombre + " no pudo entrar al free shop numero "+this.nombre+" porque no había espacio, se canso de esperar y vuelve a la sala de espera de embarque" + Color.RESET);
        }
